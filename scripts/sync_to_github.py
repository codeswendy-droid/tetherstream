...
FILES_TO_SYNC = [
    ...
    'services/api/src/modules/settlement/pesapal/pesapal.module.ts',
    'services/api/src/modules/settlement/cryptobot/cryptobot.provider.ts',
    'services/api/src/modules/settlement/usdt/usdt.provider.ts',
    'services/api/src/modules/settlement/settlement-provider.interface.ts',
    ...
    'apps/web/src/components/funding/UsdtFunding.tsx',
    ...
    'apps/web/src/store/useWalletStore.ts',
    ...
    'services/api/src/modules/fraud/fraud-detection.service.ts',
    'services/api/src/modules/growth/reward.service.ts',
    'package.json',
